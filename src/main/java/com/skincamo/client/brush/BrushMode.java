...
public final class BrushMode {
    ...
    public static void tick(Minecraft mc) {
        ...
        // Calculamos a direção nós mesmos a partir do pitch/yaw da câmera em
        // vez de usar getLookVector() diretamente - o tipo de retorno desse
        // método (Vector3f do JOML) não é o que esperávamos, e essa conta é
        // a mesma fórmula padrão (e já comprovada) usada em PlayerBodyGeometry.
